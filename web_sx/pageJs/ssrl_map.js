...
//行点击
$("#table").on("click",".eachBox",function(){
	$(this).addClass("on").siblings().removeClass('on');
	//加图片
	var point_lng = $(this).attr("lng");
	var point_lat =$(this).attr("lat");
	var point_dw = [point_lng,point_lat];
	if(newMarker){
	    newMarker.remove();
	}
	var divNode = document.createElement('div');
	divNode.innerHTML = '<img src="images/ssrl/camera.png" />';
	newMarker=new mapboxgl.Marker(divNode).setLngLat(point_dw).addTo(map);

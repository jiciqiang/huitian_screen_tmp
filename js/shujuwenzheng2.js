...
(function($){
    var _dataList = [
        ...
        {"id": 2, "name": "教育培训", "list": [
            {"id": 1, "name": "普惠性幼儿园数量", "value": 47, "color": "#52d043"},
            {"id": 2, "name": "幼儿园学位数", "value": 12275, "color": "#52d043"},

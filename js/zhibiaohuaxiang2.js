...
(function($){
    ...
    function addEvent(){
        $(document).on('click', '#topLeftNavList li', function(){
            if(0!=$(this).index()){
                _index = $(this).index()-1;
                $.ListenMapDataChange.trigger({ index: _index, data: _dataList[_index] });
                renderHtml();
            }
        });
...
(function($){
    ...
    var _dataList = [
        {"id": 1, "name": "东小口森林公园项目", "status": "完工投用", "url": "javascript:;", "color": "#43ca26"},
        {"id": 2, "name": "东小口森林公园项目", "status": "完工投用", "url": "javascript:;", "color": "#43ca26"},
        {"id": 3, "name": "东小口森林公园项目", "status": "新建未开", "url": "javascript:;", "color": "#ffa839"},
        {"id": 4, "name": "东小口森林公园项目", "status": "续建复工", "url": "javascript:;", "color": "#ffef95"},
        {"id": 5, "name": "东小口森林公园项目", "status": "完工投用", "url": "javascript:;", "color": "#43ca26"}
    ];

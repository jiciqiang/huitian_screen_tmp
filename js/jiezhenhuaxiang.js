...
(function($){
    ...
    var _dataList = [
        {"id": 1, "name": "便利性", "value": 8.6, "max": 10, "color": "#42ca23"},
        {"id": 2, "name": "幼有所育", "value": 9.0, "max": 10, "color": "#42ca23"},
        {"id": 3, "name": "公正性", "value": 7.2, "max": 10, "color": "#eb4c3d"},
        {"id": 4, "name": "弱有所扶", "value": 7.2, "max": 10, "color": "#eb4c3d"},
        {"id": 5, "name": "安全性", "value": 7.3, "max": 10, "color": "#eb4c3d"},
        {"id": 6, "name": "病有所医", "value": 7.4, "max": 10, "color": "#f38432"},
        {"id": 7, "name": "宜居性", "value": 7.6, "max": 10, "color": "#f38432"},
        {"id": 8, "name": "住有所居", "value": 7.7, "max": 10, "color": "#f1d235"},
        {"id": 9, "name": "老有所养", "value": 7.9, "max": 10, "color": "#b0bb39"},
        {"id": 10, "name": "多样性", "value": 8.0, "max": 10, "color": "#a3bb39"},
        {"id": 11, "name": "劳有所得", "value": 8.2, "max": 10, "color": "#8dbb33"},
        {"id": 12, "name": "学有所教", "value": 8.4, "max": 10, "color": "#61b02b"},
    ];
...
(function($){
    ...
    var _staticList = [
        ...
        _dataList = [
            ...
            {"id": 2, "title": "回龙观镇居住及公共设施项目（朱辛庄地区）配套养老设施（公办）", "status": "完工投用", "url": "javascript:;"},
            {"id": 3, "title": "回龙观镇居住及公共设施项目（朱辛庄地区）配套养老设施（公办）", "status": "完工投用", "url": "javascript:;"},
            {"id": 4, "title": "回龙观镇居住及公共设施项目（朱辛庄地区）配套养老设施（公办）", "status": "完工投用", "url": "javascript:;"},
            {"id": 5, "title": "回龙观镇居住及公共设施项目（朱辛庄地区）配套养老设施（公办）", "status": "完工投用", "url": "javascript:;"},
            {"id": 6, "title": "回龙观镇居住及公共设施项目（朱辛庄地区）配套养老设施（公办）", "status": "完工投用", "url": "javascript:;"}
        ];

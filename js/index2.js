...
(function($){
    var _dataList = [
            {"id": 1, "title": "21点 天通苑北二区", "intro": "30栋住宅楼发生大面积停电 "},
            {"id": 2, "title": "22点 天通苑北二区", "intro": "30栋住宅楼发生大面积停电 "},
            {"id": 3, "title": "23点 天通苑北二区", "intro": "30栋住宅楼发生大面积停电 "},
            {"id": 4, "title": "1点 天通苑北二区", "intro": "30栋住宅楼发生大面积停电 "},
            {"id": 5, "title": "2点 天通苑北二区", "intro": "30栋住宅楼发生大面积停电 "}
        ],
        _dataIndex = 0,
        _handle,
        _dataList2 = [
            {"id": 1, "title": "11月-12月 回龙观街道", "intro": "供暖不足问题投诉量巨大 "},
            {"id": 2, "title": "1月-2月 回龙观街道", "intro": "供暖不足问题投诉量巨大 "},
            {"id": 3, "title": "3月-4月 回龙观街道", "intro": "供暖不足问题投诉量巨大 "},
            {"id": 4, "title": "5月-6月 回龙观街道", "intro": "供暖不足问题投诉量巨大 "},
            {"id": 5, "title": "7月-8月 回龙观街道", "intro": "供暖不足问题投诉量巨大 "}
        ],
        _dataIndex2 = 0,
        _handle2;
...
(function($){
    ...
    var _dataList = [
            ...
            { name: "公共设施不完善", value: 4386, color: "#ea4c3e" },
            { name: "交通拥堵", value: 4055, color: "#f48d46" },
            { name: "潮汐紧密", value: 2467, color: "#f1d236" },
            { name: "公共设施不完善", value: 2244, color: "#ea4c3e" },
            { name: "交通拥堵",value: 1898, color: "#f48d46" },
            { name: "潮汐紧密", value: 1484, color: "#ea4c3e" },
            { name: "公共设施不完善", value: 1484, color: "#f48d46" },
            { name: "交通拥堵", value: 1484, color: "#f1d236" },
            { name: "潮汐紧密", value: 1484, color: "#ea4c3e" },
        ],
        _dataList2 = [
            { name: "交通拥堵", value: 599, color: "#ea4c3e" },
            { name: "潮汐紧密", value: 3213, color: "#f1d236" },
            { name: "公共设施不完善", value: 2366, color: "#ea4c3e" },
            { name: "交通拥堵", value: 3677, color: "#f48d46" },
            { name: "潮汐紧密", value: 1442, color: "#ea4c3e" },
            { name: "公共设施不完善", value: 1743, color: "#ea4c3e" },
            { name: "交通拥堵",value: 1898, color: "#f48d46" },
            { name: "潮汐紧密", value: 1484, color: "#ea4c3e" },
            { name: "公共设施不完善", value: 2321, color: "#ea4c3e" },
            { name: "交通拥堵", value: 12345, color: "#f48d46" },
